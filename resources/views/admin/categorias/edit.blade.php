...
@section('content_header')
    <h1><b>Categoría/Modificar datos de la categoría</b></h1>
    <hr>
@stop
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="nombre_cat">Nombre de la Categoría</label><b> (*)</b>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <textarea class="form-control" name="descripcion_cat" rows="3"
                                                  placeholder="Ingrese descripción...">{{ old('descripcion_cat', $categoria->descripcion_cat) }}</textarea>
                                    </div>
