...
@section('title', 'Servicio/Modificar datos del servicio')

@section('content_header')
    <h1><b>Modificar Servicio</b></h1>
    <hr>
@stop
                    ...
                    <form action="{{ route('admin.servicios.update', $servicio->id) }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <select name="prestador_id" id="prestador_id" class="form-control" required>
                                            ...
                                            @foreach($prestadores as $prestador)
                                                <option value="{{ $prestador->id }}" {{ old('prestador_id', $servicio->prestador_id) == $prestador->id ? 'selected' : '' }}>
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <select name="subcategoria_id" id="subcategoria_id" class="form-control" required>
                                            ...
                                            @foreach($subcategorias as $subcategoria)
                                                <option value="{{ $subcategoria->id }}" {{ old('subcategoria_id', $servicio->subcategoria_id) == $subcategoria->id ? 'selected' : '' }}>
                                                    {{ $subcategoria->nombre }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <select name="tipo_precio" id="tipo_precio" class="form-control" required>
                                            @foreach($tiposPrecio as $value => $label)
                                                <option value="{{ $value }}" {{ old('tipo_precio', $servicio->tipo_precio) == $value ? 'selected' : '' }}>
                                                    {{ $label }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group" id="precio-field">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="number" class="form-control" name="precio" id="precio" 
                                               value="{{ old('precio', $servicio->precio) }}" step="0.01" min="0" placeholder="0.00">
                                    </div>
                                    @error('precio')
                                    <small style="color: red">{{$message}}</small>
                                    @enderror
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <textarea name="descripcion" id="descripcion" class="form-control" rows="4" 
                                          placeholder="Ingrese descripción del servicio..." required>{{ old('descripcion', $servicio->descripcion) }}</textarea>
                            </div>
                            @error('descripcion')
                            <small style="color: red">{{$message}}</small>
                            @enderror
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <div class="custom-file">
                                    ...
                                    <label class="custom-file-label" for="imagen">
                                        {{ $servicio->imagen ? basename($servicio->imagen) : 'Seleccionar imagen...' }}
                                    </label>
                                </div>
                            </div>
                            @if($servicio->imagen)
                            <div class="mt-2">
                                ...
                                <small class="form-text text-muted">Imagen actual del servicio</small>
                            </div>
                            @endif
                            @error('imagen')
                            <small style="color: red">{{$message}}</small>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="direccion" id="direccion" 
                                               value="{{ old('direccion', $servicio->direccion) }}" placeholder="Ingrese dirección..." required>
                                    </div>
                                    @error('direccion')
                                    <small style="color: red">{{$message}}</small>
                                    @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="ciudad" id="ciudad" 
                                               value="{{ old('ciudad', $servicio->ciudad) }}" placeholder="Ingrese ciudad..." required>
                                    </div>
                                    @error('ciudad')
                                    <small style="color: red">{{$message}}</small>
                                    @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="provincia" id="provincia" 
                                               value="{{ old('provincia', $servicio->provincia) }}" placeholder="Ingrese provincia..." required>
                                    </div>
                                    @error('provincia')
                                    <small style="color: red">{{$message}}</small>
                                    @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="pais" id="pais" 
                                               value="{{ old('pais', $servicio->pais) }}" placeholder="Ingrese país..." required>
                                    </div>
                                    @error('pais')
                                    <small style="color: red">{{$message}}</small>
                                    @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="latitud" id="latitud" 
                                               value="{{ old('latitud', $servicio->latitud) }}" {{ empty(config('services.google.maps.maps_api_key')) ? '' : 'readonly' }}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="longitud" id="longitud" 
                                               value="{{ old('longitud', $servicio->longitud) }}" {{ empty(config('services.google.maps.maps_api_key')) ? '' : 'readonly' }}
...
async function initMap() {
    ...
    const currentLocation = { 
        lat: {{ $servicio->latitud ?? -17.4040 }}, 
        lng: {{ $servicio->longitud ?? -66.0409 }} 
    };
